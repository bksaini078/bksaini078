...
**Applied AI Researcher | Large Language Models & Multi-Agent Systems**
...
### Research & Expertise
My work centers on the intersection of **Generative AI** and **Behavioral Simulation**. I am particularly interested in:
* **Multi-Agent Systems (MAS):** Architecting collaborative AI frameworks for autonomous decision-making.
* **Digital Human Modeling:** Utilizing LLMs to simulate human perspectives for market research and user experience studies.
* **Explainable AI (XAI):** Ensuring transparency and human oversight in complex AI-driven environments.
* **Prototype Development:** Rapidly translating research concepts into functional, high-impact AI tools.

### Professional Experience
* **Applied AI Researcher | Fraunhofer IAO**
  Focusing on enterprise AI strategy, prototype development, and the integration of GenAI into professional workflows.
